...
void CScene::OnProcessingMouseMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam)
{
	RECT rt[3] =
	{
		{ FRAME_BUFFER_WIDTH / 2 + 250, FRAME_BUFFER_HEIGHT - 280, FRAME_BUFFER_WIDTH / 2 + 400, FRAME_BUFFER_HEIGHT - 80 },
		{ FRAME_BUFFER_WIDTH / 2 + 500, FRAME_BUFFER_HEIGHT - 280,FRAME_BUFFER_WIDTH / 2 + 600, FRAME_BUFFER_HEIGHT - 80 },
		{ FRAME_BUFFER_WIDTH / 2 + 750,FRAME_BUFFER_HEIGHT - 280, FRAME_BUFFER_WIDTH / 2 + 800, FRAME_BUFFER_HEIGHT - 80 },
	};
