...
CShader* CMaterial::m_pGroundRangeShader = NULL;
...
void CMaterial::PrepareShaders(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature)
{
	...
	m_pGroundRangeShader = new CGroundRangeShader();
	m_pGroundRangeShader->CreateShader(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature);
	m_pGroundRangeShader->CreateShaderVariables(pd3dDevice, pd3dCommandList);
}
